...
| **Raison d'être** | Second run de la validation de la fabrique (voir `2026-08-04-ardoise-prd.md`), avec les corrections du run 1 en place, et deux angles qu'`ardoise` ne couvrait pas |
