...
Troisième temps, demandé après validation du plan : **les seize gestes sont
appliqués**, en six commits, dans l'ordre d'exécution du plan. Écart au contrat
assumé une fois, et une seule : le geste 7 touche deux lignes d'un test de
`renaissance-gym`, écrites directement plutôt que confiées à l'`artisan` — un
motif d'expression régulière et un message d'assertion ne valent pas un agent.

Cinq anomalies rencontrées **en menant ce travail**, quatre dans les outils qui
devaient le rendre possible ou le mesurer, et une hors du dépôt.
...
### 5. Aucun runner n'est attribué : la CI ne démarre plus du tout

**Symptome** — depuis le commit `3ca5fde` (10:53 UTC), chaque poussée voit les
jobs `contrat` et `detect` échouer en **deux secondes**, sans une ligne de log —
l'API rend `HTTP 404` sur leur téléchargement. Les quatre jobs suivants sont
`skipped`. Trois commits d'affilée, plus une relance explicite de
`rerun_failed_jobs` : même issue à chaque fois.

**Cause** — hors du dépôt. Le job porte `runner_id: 0` et `runner_name: ""` :
aucune machine ne lui a jamais été attribuée, donc rien n'a démarré. Ce n'est ni
le workflow ni le contenu du commit — le même workflow était vert à 10:03 sur
`1213c22`, et `./init.sh --check`, que le job `contrat` se contente de lancer,
est vert en local sur chacun des six commits. La cause plausible est un
épuisement des minutes GitHub Actions ou une limite de dépense sur un dépôt
privé ; le dépôt ne peut ni la voir ni la corriger.

**Detecte par** — `CI`

**Action** — `arbitrage` — demande un geste humain hors du dépôt : vérifier la
facturation Actions du compte. En attendant, les six commits sont couverts par
les quatre harnais locaux, qui sont exactement ce que la CI lance — mais
« exactement ce que la CI lance » vérifié à la main n'est pas la CI, et la
branche ne devrait pas fusionner sur cette seule foi.

<!-- cout : genere par ./scripts/cout.sh, ne pas editer a la main -->
## Coût

Relevé le 2026-08-16 à 12:30 UTC, sur 1 session(s) lisible(s) depuis
...
|---|---:|---:|
| Entrée | 41 352 | 0,10 $ |
| Écriture de cache | 1 918 022 | 8,99 $ |
| Lecture de cache | 94 733 627 | 42,79 $ |
| Sortie | 179 747 | 3,83 $ |
| **Total** | **96 872 748** | **55,72 $ — 48,39 €** |

**Ce qui coûte**

- **549 appel(s) au modèle** — un par réponse, outils compris —, dont 256 par des sous-agents — 21 515 901 jetons, 10,41 $.
- **Démarrage** — contrat, outillage et définitions d'outils pèsent
  60 960 jetons, écrits une fois par session puis relus à chaque
  échange : 17 800 320 jetons de relecture, 18 % de tout ce qui a été relu.
- **Tours courts** — 384 des 549 tours (69 %) sortent
  moins de 300 jetons : un appel d'outil nu, qui paie tout le contexte relu pour
  une sortie de rien. Ils coûtent 30,01 $, soit 53 % de la facture.
  Grouper les appels indépendants dans un même tour divise ce poste.
- **Croissance** — 60 960 jetons relus au premier appel qui relise
  quelque chose, 423 206 au dernier : une session longue se paie à chaque tour.
...
221 principal claude-opus-4-7 8548 29200 152
222 principal claude-opus-5 1779 372051 484
223 principal claude-opus-4-7 995 37748 120
224 principal claude-opus-4-7 180 38743 75
225 principal claude-opus-4-7 120 38923 91
226 principal claude-opus-5 2707 373830 191
227 principal claude-opus-4-7 112 39043 82
228 principal claude-opus-4-7 3928 39155 122
229 principal claude-opus-5 745 376537 418
230 principal claude-opus-4-7 3840 43083 1535
231 principal claude-opus-4-7 3084 46923 80
232 principal claude-opus-5 1451 377282 1507
233 principal claude-opus-5 1579 378733 331
234 principal claude-opus-5 456 380312 368
235 principal claude-opus-5 419 380768 112
318 agent claude-sonnet-5 21733 27616 5
319 agent claude-sonnet-5 1997 49349 2
320 agent claude-sonnet-5 564 51346 3
321 agent claude-sonnet-5 801 51910 2
322 agent claude-sonnet-5 1901 52711 10
323 agent claude-sonnet-5 1170 54612 6
324 agent claude-sonnet-5 6258 55782 7
325 agent claude-sonnet-5 2569 62040 2
326 agent claude-sonnet-5 2096 64609 9
327 agent claude-sonnet-5 2725 66705 6
328 agent claude-sonnet-5 2753 69430 2
329 agent claude-sonnet-5 848 72183 3
330 agent claude-sonnet-5 1679 73031 8
331 agent claude-sonnet-5 1666 74710 2
332 agent claude-sonnet-5 2085 76376 2
333 agent claude-sonnet-5 175 78461 5
334 agent claude-sonnet-5 251 78636 3
335 agent claude-sonnet-5 2007 78887 8
336 agent claude-sonnet-5 3381 80894 8
337 agent claude-sonnet-5 3418 84275 7
338 agent claude-sonnet-5 2477 87693 7
339 agent claude-sonnet-5 493 90170 3
340 agent claude-sonnet-5 666 90663 3
341 agent claude-sonnet-5 1281 91329 3
342 agent claude-sonnet-5 2898 92610 7
343 agent claude-sonnet-5 1538 95508 3
344 agent claude-sonnet-5 3433 97046 2
345 agent claude-sonnet-5 751 100479 2
346 agent claude-sonnet-5 3404 101230 8
347 agent claude-sonnet-5 322 104634 3
348 agent claude-sonnet-5 419 104956 2
349 agent claude-sonnet-5 15890 27927 5
350 agent claude-sonnet-5 22940 43817 6
351 agent claude-sonnet-5 492 66757 20
352 agent claude-sonnet-5 1526 67249 2
353 agent claude-sonnet-5 2328 68775 6
354 agent claude-sonnet-5 2262 71103 3
355 agent claude-sonnet-5 477 73365 17
356 agent claude-sonnet-5 3358 73842 7
357 agent claude-sonnet-5 1135 77200 4
358 agent claude-sonnet-5 1447 78335 3
359 agent claude-sonnet-5 236 79782 20
360 agent claude-sonnet-5 372 80018 2
361 agent claude-sonnet-5 1857 80390 3
362 agent claude-sonnet-5 441 82247 6
363 agent claude-sonnet-5 504 82688 20
364 agent claude-sonnet-5 1063 83192 20
365 agent claude-sonnet-5 231 84255 20
366 agent claude-sonnet-5 931 84486 2
367 agent claude-sonnet-5 339 85417 20
368 agent claude-sonnet-5 254 85756 3
369 agent claude-sonnet-5 411 86010 2
370 agent claude-sonnet-5 1112 86421 6
371 agent claude-sonnet-5 1164 87533 3
372 agent claude-sonnet-5 3441 88697 3
373 agent claude-sonnet-5 901 92138 2
374 agent claude-sonnet-5 1953 93039 3
375 agent claude-sonnet-5 9812 94992 2
376 agent claude-sonnet-5 436 104804 20
377 agent claude-sonnet-5 5391 105240 3
378 agent claude-sonnet-5 3966 110631 4
379 agent claude-sonnet-5 1659 114597 3
380 agent claude-sonnet-5 1948 116256 4
381 agent claude-sonnet-5 551 118204 2
382 agent claude-sonnet-5 1207 118755 5
383 agent claude-sonnet-5 9807 119962 3
384 agent claude-sonnet-5 1245 129769 3
385 agent claude-sonnet-5 1914 131014 3
386 agent claude-sonnet-5 1519 132928 8
387 agent claude-sonnet-5 3690 134447 3
388 agent claude-sonnet-5 690 138137 2
389 agent claude-sonnet-5 297 138827 2
390 agent claude-sonnet-5 46768 0 5
391 agent claude-sonnet-5 4762 46768 2
392 agent claude-sonnet-5 7685 51530 6
393 agent claude-sonnet-5 1695 59215 2
394 agent claude-sonnet-5 2055 60910 6
395 agent claude-sonnet-5 3385 62965 2
396 agent claude-sonnet-5 799 66350 2
397 agent claude-sonnet-5 3334 67149 2
398 agent claude-sonnet-5 515 70483 8
399 agent claude-sonnet-5 1090 70998 7
400 agent claude-sonnet-5 2463 72088 2
401 agent claude-sonnet-5 1335 74551 10
402 agent claude-sonnet-5 1805 75886 8
403 agent claude-sonnet-5 8098 77691 8
404 agent claude-sonnet-5 1541 85789 2
405 agent claude-sonnet-5 873 87330 5
406 agent claude-sonnet-5 2516 88203 4
407 agent claude-sonnet-5 4851 90719 8
408 agent claude-sonnet-5 19479 27616 5
409 agent claude-sonnet-5 3550 47095 2
410 agent claude-sonnet-5 1593 50645 3
411 agent claude-sonnet-5 1283 52238 2
412 agent claude-sonnet-5 1087 53521 3
413 agent claude-sonnet-5 1150 54608 6
414 agent claude-sonnet-5 2953 55758 4
415 agent claude-sonnet-5 596 58711 5
416 agent claude-sonnet-5 881 59307 3
417 agent claude-sonnet-5 1095 60188 3
418 agent claude-sonnet-5 2642 61283 6
419 agent claude-sonnet-5 1737 63925 3
420 agent claude-sonnet-5 1698 65662 3
421 agent claude-sonnet-5 1786 67360 9
422 agent claude-sonnet-5 4780 69146 3
423 agent claude-sonnet-5 2935 73926 5
424 agent claude-sonnet-5 1226 76861 5
425 agent claude-sonnet-5 2238 78087 3
426 agent claude-sonnet-5 5624 80325 3
427 agent claude-sonnet-5 2995 85949 3
428 agent claude-sonnet-5 703 88944 8
429 agent claude-sonnet-5 586 89647 4
430 agent claude-sonnet-5 2539 90233 7
431 agent claude-sonnet-5 1479 92772 3
432 agent claude-sonnet-5 1212 94251 3
433 agent claude-opus-5 76671 0 5
434 agent claude-opus-5 8518 76671 5
435 agent claude-opus-5 3729 85189 4
436 agent claude-opus-5 1045 88918 3
437 agent claude-opus-5 4510 89963 2
438 agent claude-opus-5 3195 94473 3
439 agent claude-opus-5 21763 97668 3
440 agent claude-sonnet-5 19889 27616 4
441 agent claude-sonnet-5 3944 47505 5
442 agent claude-sonnet-5 1897 51449 2
443 agent claude-sonnet-5 2051 53346 5
444 agent claude-sonnet-5 443 55397 2
445 agent claude-sonnet-5 5481 55840 3
446 agent claude-sonnet-5 487 61321 7
447 agent claude-sonnet-5 6930 61808 2
448 agent claude-sonnet-5 844 68738 6
449 agent claude-sonnet-5 1008 69582 4
450 agent claude-sonnet-5 1264 70590 4
451 agent claude-sonnet-5 733 71854 20
452 agent claude-sonnet-5 887 72587 2
453 agent claude-sonnet-5 658 73474 3
454 agent claude-sonnet-5 194 74132 3
455 agent claude-sonnet-5 212 74326 3
456 agent claude-sonnet-5 1438 74538 3
457 agent claude-sonnet-5 1286 75976 2
458 agent claude-sonnet-5 1104 77262 2
459 agent claude-sonnet-5 855 78366 3
460 agent claude-sonnet-5 1153 79221 3
461 agent claude-sonnet-5 1845 80374 2
462 agent claude-sonnet-5 411 82219 20
463 agent claude-sonnet-5 1246 82630 7
464 agent claude-sonnet-5 2349 83876 6
465 agent claude-sonnet-5 205 86225 9
466 agent claude-sonnet-5 1256 86430 3
467 agent claude-sonnet-5 748 87686 2
468 agent claude-sonnet-5 2863 88434 5
469 agent claude-sonnet-5 283 91297 7
470 agent claude-sonnet-5 15770 27927 3
471 agent claude-sonnet-5 5999 43697 4
472 agent claude-sonnet-5 21487 49696 2
473 agent claude-sonnet-5 3743 71183 3
474 agent claude-sonnet-5 1066 74926 2
475 agent claude-sonnet-5 4736 75992 6
476 agent claude-sonnet-5 1941 80728 3
477 agent claude-sonnet-5 3025 82669 3
478 agent claude-sonnet-5 7430 85694 9
479 agent claude-sonnet-5 8648 93124 3
480 agent claude-sonnet-5 329 101772 2
481 agent claude-sonnet-5 1630 102101 2
482 agent claude-sonnet-5 15866 27927 3
483 agent claude-sonnet-5 26225 43793 2
484 agent claude-sonnet-5 6069 70018 3
485 agent claude-sonnet-5 12449 76087 4
486 agent claude-sonnet-5 2806 88536 8
487 agent claude-sonnet-5 2489 91342 3
488 agent claude-sonnet-5 1146 93831 2
489 agent claude-sonnet-5 5598 94977 3
490 agent claude-sonnet-5 2913 100575 7
491 agent claude-sonnet-5 4079 103488 3
492 agent claude-sonnet-5 1745 107567 2
493 agent claude-sonnet-5 2296 109312 2
494 agent claude-sonnet-5 4959 111608 2
495 agent claude-sonnet-5 883 116567 2
496 agent claude-sonnet-5 4104 117450 2
497 agent claude-sonnet-5 3820 121554 8
498 agent claude-sonnet-5 830 125374 3
499 agent claude-sonnet-5 1553 126204 2
500 agent claude-sonnet-5 1065 127757 2
501 agent claude-sonnet-5 4625 128822 3
502 agent claude-sonnet-5 2118 133447 2
503 agent claude-sonnet-5 43686 0 5
504 agent claude-sonnet-5 12642 43686 2
505 agent claude-sonnet-5 21318 56328 9
506 agent claude-sonnet-5 1192 77646 2
507 agent claude-sonnet-5 3150 78838 3
508 agent claude-sonnet-5 8028 81988 5
509 agent claude-sonnet-5 11774 90016 3
510 agent claude-sonnet-5 1116 101790 2
511 agent claude-sonnet-5 5469 102906 3
512 agent claude-sonnet-5 255 108375 2
513 agent claude-sonnet-5 1323 108630 9
514 agent claude-sonnet-5 6077 109953 3
515 agent claude-sonnet-5 1999 116030 2
516 agent claude-sonnet-5 4105 118029 8
517 agent claude-sonnet-5 15819 27927 5
518 agent claude-sonnet-5 12204 43746 2
519 agent claude-sonnet-5 395 55950 3
520 agent claude-sonnet-5 2019 56345 5
521 agent claude-sonnet-5 456 58364 3
522 agent claude-sonnet-5 537 58820 2
523 agent claude-sonnet-5 11912 59357 6
524 agent claude-sonnet-5 5009 71269 2
525 agent claude-sonnet-5 691 76278 20
526 agent claude-sonnet-5 2045 76969 3
527 agent claude-sonnet-5 4892 79014 3
528 agent claude-sonnet-5 269 83906 8
529 agent claude-sonnet-5 1844 84175 5
530 agent claude-sonnet-5 1021 86019 2
531 agent claude-sonnet-5 931 87040 8
532 agent claude-sonnet-5 3673 87971 3
533 agent claude-sonnet-5 1072 91644 4
534 agent claude-sonnet-5 294 92716 8
535 agent claude-sonnet-5 1403 93010 3
536 agent claude-sonnet-5 3228 94413 3
537 agent claude-sonnet-5 4491 97641 3
538 agent claude-sonnet-5 3022 102132 20
539 agent claude-sonnet-5 728 105154 2
540 agent claude-sonnet-5 539 105882 20
541 agent claude-sonnet-5 776 106421 8
542 agent claude-sonnet-5 973 107197 7
543 agent claude-sonnet-5 2179 108170 3
544 agent claude-sonnet-5 736 110349 3
545 agent claude-sonnet-5 644 111085 3
546 agent claude-sonnet-5 1558 111729 3
547 agent claude-sonnet-5 852 113287 2
548 agent claude-sonnet-5 530 114139 8
549 agent claude-sonnet-5 998 114669 2
-->
<!-- /cout -->
