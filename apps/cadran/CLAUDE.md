# cadran — notice de contexte

<!-- GENERE par ./init.sh depuis apps/cadran/app.yml et fabrique.yml.
     Ne l'edite pas : --check refuse une notice qui a derive. -->

## Ton perimetre

Tu travailles dans `apps/cadran/` et nulle part ailleurs. Si ton changement demande
...
- Nom : `cadran` — c'est aussi son sous-domaine, son conteneur et sa route.
- URL : https://cadran.apps.billbob.ovh
...
- `apps/cadran/PRODUCT.md` — la fiche produit, puis les exigences.
- `apps/cadran/README.md` — le mode d'emploi technique.
